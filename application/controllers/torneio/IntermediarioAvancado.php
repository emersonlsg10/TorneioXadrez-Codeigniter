...
class IntermediarioAvancado extends Ponto {
    ...
    function verificar() {
        if ($this->jogador1['categoria'] == "Intermediario") {
    ...
    function segundoJogador() {
        switch ($this->resultado) {
            case 1:
                $this->jogador1['pontos'] += 1;
                $this->jogador2['pontos'] += 0.25;
                //vitoria e derrota
                $this->jogador1['vitorias'] += 1;
                $this->jogador2['derrotas'] += 1;
                break;
            case 2:
                $this->jogador2['pontos'] += 1.5;
